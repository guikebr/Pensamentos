...
class QuotesViewController: UIViewController {
    ...
    func formatView(){
        view.backgroundColor = config.colorSheme == 0 ? .white : UIColor(red: 156.0/255.0, green: 68.0/255.0, blue: 15.0/255.0, alpha: 1.0)
        lbQuotes.textColor = config.colorSheme == 0 ? .black : .white
        lbAuthor.textColor = config.colorSheme == 0 ? UIColor(red: 192/255.0, green: 96/255.0, blue: 49.0/255.0, alpha: 1.0) : .yellow
        prepareQuote()
    }
